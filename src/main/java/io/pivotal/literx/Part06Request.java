...
//========================================================================================
	...
	// TODO Return a Flux with all users stored in the repository 
	//that prints "Starring:" on subscribe, "firstname lastname" for all values and "The end!" on complete
	Flux<User> fluxWithDoOnPrintln() {
		return repository.findAll()
				.doOnSubscribe(s -> System.out.println("Starring:"))
				.doOnNext(n -> System.out.println("firstname " + n.getFirstname()  +" lastname: " + n.getLastname()))
